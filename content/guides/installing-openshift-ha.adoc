...
date: 2018-02-23T19:30:57-05:00
authors: ["redhat-cop"]
categories:
  - Implementation
tags:
...
The Ansible config playbook will by default generate a bunch of certificates that will be used by various components. If you have need to customize these certificates, consult link:/guides/custom-certificates[Configuring OpenShift to use Custom Certificates].
