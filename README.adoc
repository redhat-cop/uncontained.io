...
image:https://github.com/redhat-cop/uncontained.io/workflows/.github/workflows/CI/badge.svg["Language Linter"]
image:https://github.com/redhat-cop/uncontained.io/workflows/.github/workflows/local-dev-test/badge.svg["Tests"]
image:https://github.com/redhat-cop/uncontained.io/workflows/.github/workflows/local-dev-publish/badge.svg["Docker Repository on Quay", link="https://quay.io/repository/redhat-cop/uncontained-local-dev"]
