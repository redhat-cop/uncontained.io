...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it uncontained
....
...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it uncontained run start-preview
....
...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it uncontained run build
....
