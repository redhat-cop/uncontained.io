...
....
docker run quay.io/redhat-cop/uncontained
....
...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it --net=host uncontained
....
...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it --net=host uncontained run start-preview
....
...
....
docker run -u $(id -u) -v ${PWD}:/uncontained.io:Z -it --net=host uncontained run build
....
