---
date: "2018-02-24T01:24:26-05:00"
title: "Validating an OpenShift Install"
authors: ["redhat-cop"]
categories:
  - Add On
tags:
...
After completing the process of building an OpenShift environment, it's important to go through a few validation steps to ensure that all components are in proper working order. This document walks you through those steps.
