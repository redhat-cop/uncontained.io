---
title: "Monitoring Applications With the Prometheus Operator"
...
== Official Metrics libraries for apps
...
Scaling horizontally or vertically? One Prometheus per namespace? Per team? Per cluster? 
