...
----
+
. Add CA certificates to the `additionalTrustBundle` property:
+
[source]
----
apiVersion: v1
...
Additional information for providing CA certificates at installation and runtime can be found in the link:https://docs.openshift.com/container-platform/4.3/networking/configuring-a-custom-pki.html[Configuring a custom PKI] documentation
