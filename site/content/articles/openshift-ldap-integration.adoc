...
The OpenShift Container Platform provides support for leveraging users and groups stored in an Lightweight Directory Access Protocol (LDAP) V3 server using simple bind authentication. This article walks through a typical integration between OpenShift and an Enterprise LDAP or Active Directory system.
